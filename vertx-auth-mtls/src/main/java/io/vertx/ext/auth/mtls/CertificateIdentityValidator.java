...
/**
 * {@link CertificateIdentityValidator} interface can be extended to implement custom certificate identity validator.
 */
public interface CertificateIdentityValidator
{
     ...
     *
     * @param identity {@code String} string extracted from certificate, uniquely represents client
