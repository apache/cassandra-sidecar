...
/**
 * A {@link CassandraTableOperations} extension for Cassandra 5.0 that supports SAI index validation
...
public class Cassandra50TableOperations extends CassandraTableOperations
{
    ...
    {
        return jmxClient.proxy(Cassandra50TableJmxOperations.class, tableMBeanName(keyspace, tableName))
