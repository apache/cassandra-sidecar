...
/**
 * An interface that extends {@link TableJmxOperations} with the Cassandra 5.0 MBean signature
 * for {@code importNewSSTables}, which includes SAI index validation parameters.
 */
public interface Cassandra50TableJmxOperations extends TableJmxOperations
{
    /**
     * Load new sstables from the given directory with SAI index validation support.
     *
