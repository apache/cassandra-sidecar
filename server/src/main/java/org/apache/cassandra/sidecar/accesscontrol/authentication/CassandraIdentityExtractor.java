...
{
    protected final IdentityRoleCache identityRoleCache;
    protected final Set<String> adminIdentities = new HashSet<>();

    public CassandraIdentityExtractor(IdentityRoleCache identityRoleCache,
                                      Set<String> adminIdentities)
    {
        this.identityRoleCache = identityRoleCache;
    ...
    public List<String> validIdentities(CertificateCredentials certificateCredentials) throws CredentialValidationException
    {
        ...
        for (String identity : identities)
        {
            ...
            if (adminIdentities.contains(identity) || identityRoleCache.contains(identity))
            {
