...
public class Server
{
    ...
    public Future<CompositeFuture> close()
    {
        ...
        Promise<Void> closeSidecarClientPromise = Promise.promise();
        sidecarClientProvider.close(closeSidecarClientPromise);
        closingFutures.add(closeSidecarClientPromise.future());
