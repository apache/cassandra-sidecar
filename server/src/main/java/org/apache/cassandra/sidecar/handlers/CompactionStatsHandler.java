 ...
 */
public class CompactionStatsHandler extends AbstractHandler<Void> implements AccessProtected
{
    /**
     ...
     */
    @Inject
    protected CompactionStatsHandler(final InstanceMetadataFetcher metadataFetcher, final ExecutorPools executorPools)
    {
                               ...
                               Void request)
    {
        ...
        executorPools.service()
                     .executeBlocking(() -> CompactionStatsConverter.toResponse(operations.compactionStats()))
