...
import static org.apache.cassandra.sidecar.adapters.base.CassandraMetricsOperations.COLUMNFAMILY;
import static org.apache.cassandra.sidecar.adapters.base.CassandraMetricsOperations.COMPACTION_ID;
import static org.apache.cassandra.sidecar.adapters.base.CassandraMetricsOperations.COMPLETED;
import static org.apache.cassandra.sidecar.adapters.base.CassandraMetricsOperations.KEYSPACE;
import static org.apache.cassandra.sidecar.adapters.base.CassandraMetricsOperations.SSTABLES;
import static org.apache.cassandra.sidecar.adapters.base.CassandraMetricsOperations.TARGET_DIRECTORY;
import static org.apache.cassandra.sidecar.adapters.base.CassandraMetricsOperations.TASK_TYPE;
import static org.apache.cassandra.sidecar.adapters.base.CassandraMetricsOperations.TOTAL;
import static org.apache.cassandra.sidecar.common.server.utils.DataTypeUtils.safeCast;
import static org.apache.cassandra.sidecar.common.server.utils.DataTypeUtils.safeParseLong;
 ...
 */
public class CompactionStatsService
{
    // Default values
    ...
    public CompactionStatsService(StorageOperations storageOperations,
    ...
    public CompactionStatsData compactionStats()
    {
        ...
        long completedCompactionsCount = DataTypeUtils.getValueAsLong(
                metricsOperations.getCompactionMetric(CompactionStatsMetrics.TOTAL_COMPACTIONS_COMPLETED));
        long dataCompactedBytes = DataTypeUtils.getValueAsLong(
                metricsOperations.getCompactionMetric(CompactionStatsMetrics.BYTES_COMPACTED));
        long abortedCompactionsCount = DataTypeUtils.getValueAsLong(
                metricsOperations.getCompactionMetric(CompactionStatsMetrics.COMPACTIONS_ABORTED));
        long reducedCompactionsCount = DataTypeUtils.getValueAsLong(
                metricsOperations.getCompactionMetric(CompactionStatsMetrics.COMPACTIONS_REDUCED));
        long sstablesDroppedFromCompactionCount = DataTypeUtils.getValueAsLong(
                metricsOperations.getCompactionMetric(CompactionStatsMetrics.SSTABLES_DROPPED_FROM_COMPACTION));
    ...
    private Map<String, Map<String, Integer>> getPendingCompactionTasksByTable()
    {
        ...
        Object value = metricsOperations.getCompactionMetric(CompactionStatsMetrics.PENDING_TASKS_BY_TABLE_NAME);
