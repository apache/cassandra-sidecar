...
{
    private final Map<Class<? extends ClassKey>, V> mapBindings;

    public IdentityMultiBindingTypeResolver(Map<Class<? extends ClassKey>, V> mapBindings)
    {
        this.mapBindings = mapBindings; // It is a no-op resolver. Pass the map as-is.
    }

    @Override
    public Map<Class<? extends ClassKey>, V> resolve()
    {
        return mapBindings;
    }
}
