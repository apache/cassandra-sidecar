...
public class BasicPermissions
{
    ...
    public static final Permission FLUSH_NODE = new DomainAwarePermission("NODE:FLUSH", KEYSPACE_SCOPE);
    ...
    public static final Permission MODIFY_GOSSIP = new DomainAwarePermission("GOSSIP:MODIFY", CLUSTER_SCOPE);
