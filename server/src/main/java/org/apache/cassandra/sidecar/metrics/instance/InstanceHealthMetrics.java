...
public class InstanceHealthMetrics
{
    ...
    public InstanceHealthMetrics(MetricRegistry registry)
    {
        ...
        jmxDown = NamedMetric.builder(name -> registry.gauge(name, () -> new DefaultSettableGauge<>(0)))
                             .withDomain(DOMAIN)
                             .withName("JmxDown")
                             .build();
        nativeDown = NamedMetric.builder(name -> registry.gauge(name, () -> new DefaultSettableGauge<>(0)))
                                .withDomain(DOMAIN)
                                .withName("NativeDown")
                                .build();
    }
