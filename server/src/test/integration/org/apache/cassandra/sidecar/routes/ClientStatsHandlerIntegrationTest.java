...
public class ClientStatsHandlerIntegrationTest extends IntegrationTestBase
{
    ...
    throws Exception
    {
        String testRoute = "/api/v1/cassandra/client-stats";
    ...
    throws Exception
    {
        ...
        String testRoute = "/api/v1/cassandra/client-stats?all=true";
        testWithClient(context, client -> {
            client.get(server.actualPort(), "127.0.0.1", testRoute)
                  .expect(ResponsePredicate.SC_OK)
                  .send(context.succeeding(response -> {
    ...
    throws Exception
    {
        ...
        String testRoute = "/api/v1/cassandra/client-stats?all=123&bad-arg=xyz";
        testWithClient(context, client -> {
            client.get(server.actualPort(), "127.0.0.1", testRoute)
                  .expect(ResponsePredicate.SC_OK)
                  .send(context.succeeding(response -> {
