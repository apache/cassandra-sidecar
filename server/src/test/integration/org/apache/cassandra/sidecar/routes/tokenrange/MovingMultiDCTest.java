...
/**
 * Multi-DC Node movement scenarios integration tests for token range replica mapping endpoint with the in-jvm dtest framework.
 */
@Tag("heavy")
...
class MovingMultiDCTest extends MovingBaseTest
{
            ...
            throws Exception
    {
        ...
        runMovingTestScenario(context, BBHelperMovingNodeMultiDC.transientStateStart, BBHelperMovingNodeMultiDC.transientStateEnd, cluster,
                generateExpectedRangeMappingMovingNodeMultiDC(moveTarget), moveTarget);
    }

    /**
     * Generates expected token range and replica mappings specific to the test case involving a 10 node cluster across 2 DCs with the last node being moved by
     * assigning it a different token
     * <p>
     ...
     */
    private Map<String, Map<Range<BigInteger>, List<String>>> generateExpectedRangeMappingMovingNodeMultiDC(long moveTarget)
    {
        CassandraIntegrationTest annotation = sidecarTestContext.cassandraTestContext().annotation;
        List<Range<BigInteger>> expectedRanges = getMovingNodesExpectedRanges(annotation.nodesPerDc(), annotation.numDcs(), moveTarget);
        /*
         * The following expected ranges are generated based on the following token assignments and pending ranges.
         *
         * Token Allocations: MIN TOKEN: -9223372036854775808 /127.0.0.1:[-5534023222112865487] /127.0.0.2:[-5534023222112865486]
         * /127.0.0.3:[-1844674407370955167] /127.0.0.10:[-3689348814741910327] (New Location) /127.0.0.4:[-1844674407370955166]
         * /127.0.0.5:[1844674407370955153] /127.0.0.6:[1844674407370955154] /127.0.0.7:[5534023222112865473] /127.0.0.8:[5534023222112865474]
         * /127.0.0.9:[9223372036854775793] /127.0.0.10:[9223372036854775793] (Old Location) MAX TOKEN: 9223372036854775807
         *
         * Pending Ranges: [-5534023222112865487, -5534023222112865486]=[127.0.0.10] [-5534023222112865486, -3689348814741910327]=[127.0.0.10]
         * [-1844674407370955166, 1844674407370955153]=[127.0.0.2] [1844674407370955153, 1844674407370955154]=[127.0.0.2] [9223372036854775794,
         * -5534023222112865487]=[127.0.0.10]
         */
        ...
        dc2Mapping.put(expectedRanges.get(0), Arrays.asList("127.0.0.2", "127.0.0.4", "127.0.0.6", "127.0.0.10"));

        dc1Mapping.put(expectedRanges.get(1), Arrays.asList("127.0.0.3", "127.0.0.5", "127.0.0.7"));
        dc2Mapping.put(expectedRanges.get(1), Arrays.asList("127.0.0.2", "127.0.0.4", "127.0.0.6", "127.0.0.10"));
        ...
        dc2Mapping.put(expectedRanges.get(2), Arrays.asList("127.0.0.4", "127.0.0.6", "127.0.0.8", "127.0.0.10"));
        ...
        dc2Mapping.put(expectedRanges.get(5), Arrays.asList("127.0.0.6", "127.0.0.8", "127.0.0.10", "127.0.0.2"));

        dc1Mapping.put(expectedRanges.get(6), Arrays.asList("127.0.0.7", "127.0.0.9", "127.0.0.1"));
        dc2Mapping.put(expectedRanges.get(6), Arrays.asList("127.0.0.6", "127.0.0.8", "127.0.0.10", "127.0.0.2"));
        ...
        dc2Mapping.put(expectedRanges.get(11), Arrays.asList("127.0.0.2", "127.0.0.4", "127.0.0.6", "127.0.0.10"));
