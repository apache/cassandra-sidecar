...
public class JoiningTestSingleNode extends JoiningBaseTest
{
            ...
            throws Exception
    {
        ...
        runJoiningTestScenario(context, cassandraTestContext,
                ...
                (cl,
                 num) -> BBHelperJoiningNode.install(cl, num, 6),
                BBHelperJoiningNode.transientStateStart, BBHelperJoiningNode.transientStateEnd, generateExpectedRangeMappingSingleJoiningNode());
    }
