...
public class JoiningTestMultipleNodes extends JoiningBaseTest
{
            ...
            throws Exception
    {
        ...
        runJoiningTestScenario(context, cassandraTestContext, BBHelperMultipleJoiningNodes::install, BBHelperMultipleJoiningNodes.transientStateStart,
                BBHelperMultipleJoiningNodes.transientStateEnd, generateExpectedRangeMappingMultipleJoiningNodes());
    }

    /**
     * Generates expected token range and replica mappings specific to the test case involving a 3 node cluster with the 2 more nodes joining the cluster
     * <p>
    ...
    private HashMap<String, Map<Range<BigInteger>, List<String>>> generateExpectedRangeMappingMultipleJoiningNodes()
    {
         ...
         *
         * Initial Ranges: [-9223372036854775808, -4611686018427387905]:["127.0.0.3","127.0.0.2","127.0.0.1"] [-4611686018427387905,
         * -3]:["127.0.0.3","127.0.0.2","127.0.0.1"] [-3, 4611686018427387899]:["127.0.0.3","127.0.0.2","127.0.0.1"] [4611686018427387899,
         * 9223372036854775807]:["127.0.0.3","127.0.0.2","127.0.0.1"]
         *
         * Pending ranges: [-3, 4611686018427387899]=[127.0.0.4:62469] [-4611686018427387905, -3]=[127.0.0.5:62472] [-4611686018427387905,
         * -2305843009213693954]=[127.0.0.4:62469] [4611686018427387899, -4611686018427387905]=[127.0.0.4:62469, 127.0.0.5:62472] (wrap-around) [-3,
         * 2305843009213693948]=[127.0.0.5:62472]
         *
         * Token assignment for new nodes: 127.0.0.4 - [-2305843009213693954] 127.0.0.5 - [2305843009213693948]
         *
        ...
        mapping.put(expectedRanges.get(0), Arrays.asList("127.0.0.1", "127.0.0.2", "127.0.0.3", "127.0.0.4", "127.0.0.5"));
        // [-4611686018427387905, -2305843009213693954]
        mapping.put(expectedRanges.get(1), Arrays.asList("127.0.0.2", "127.0.0.3", "127.0.0.1", "127.0.0.4", "127.0.0.5"));
        ...
        mapping.put(expectedRanges.get(3), Arrays.asList("127.0.0.1", "127.0.0.2", "127.0.0.3", "127.0.0.4", "127.0.0.5"));
        ...
        mapping.put(expectedRanges.get(5), Arrays.asList("127.0.0.1", "127.0.0.2", "127.0.0.3", "127.0.0.4", "127.0.0.5"));
