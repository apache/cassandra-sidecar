...
public class JoiningTestMultiDCSingleReplicated extends JoiningBaseTest
{
            ...
            throws Exception
    {
        ...
        runJoiningTestScenario(context, BBHelperMultiDC.transientStateStart, BBHelperMultiDC.transientStateEnd, cluster, generateExpectedRanges(false),
                generateExpectedRangeMappingOneof2DCs(), false);
    }

    /**
     * Generates expected token range and replica mappings specific to the test case involving a 5 node cluster with the additional node joining the cluster
     * <p>
     ...
     * <p>
     * Ranges that include the joining node will have [RF + no. joining nodes in replica-set] replicas with the replicas being the existing nodes in ring-order.
     * eg. Range 1 - A, B, C Range 2 - B, C, D (with E being the joining node) Expected Range 2 - B, C, D, E
     */
    private HashMap<String, Map<Range<BigInteger>, List<String>>> generateExpectedRangeMappingOneof2DCs()
    {

        /*
         * Initial Ranges: [-9223372036854775808, -5869418568907584607]=[127.0.0.1:52914, 127.0.0.3:52916, 127.0.0.5:52918] [-5869418568907584607,
         * -5869418568907584606]=[127.0.0.3:52916, 127.0.0.5:52918, 127.0.0.7:52920] [-5869418568907584606, -2515465100960393407]=[127.0.0.3:52918,
         * 127.0.0.5:52920, 127.0.0.7:52922] [-2515465100960393407, -2515465100960393406]=[127.0.0.5:52918, 127.0.0.7:52920, 127.0.0.9:52922]
         * [-2515465100960393406, 838488366986797793]=[127.0.0.5:52918, 127.0.0.7:52920, 127.0.0.9:52922] [838488366986797793,
         * 838488366986797794]=[127.0.0.7:52920, 127.0.0.9:52922, 127.0.0.1:52914] [838488366986797794, 4192441834933988993]=[127.0.0.7:52920, 127.0.0.9:52922,
         * 127.0.0.1:52914] [4192441834933988993, 4192441834933988994]=[127.0.0.9:52922, 127.0.0.1:52914, 127.0.0.3:52916] [4192441834933988994,
         * 7546395302881180193]=[127.0.0.9:52922, 127.0.0.1:52914, 127.0.0.3:52916] [7546395302881180193, 7546395302881180194]=[127.0.0.1:52914,
         * 127.0.0.3:52916, 127.0.0.5:52918] [7546395302881180194, 9223372036854775807]=[127.0.0.1:52914, 127.0.0.3:52916, 127.0.0.5:52918]
         *
         * Pending Ranges: [-5869418568907584607, -5869418568907584606]=[127.0.0.11:58400] [-5869418568907584606, -4192441834933989006]=[127.0.0.11:58400]
         * [4192441834933988993, 4192441834933988994]=[127.0.0.11:58400] [7546395302881180194, -5869418568907584607]=[127.0.0.11:58400] (wrap-around)
         * [7546395302881180193, 7546395302881180194]=[127.0.0.11:58400] [4192441834933988994, 7546395302881180193]=[127.0.0.11:58400]
         *
         */
