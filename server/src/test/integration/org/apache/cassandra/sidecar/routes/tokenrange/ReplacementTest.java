...
class ReplacementTest extends ReplacementBaseTest
{
            ...
            throws Exception
    {
        ...
        runReplacementTestScenario(context, cassandraTestContext, BBHelperReplacementsNode::install, BBHelperReplacementsNode.nodeStart,
                BBHelperReplacementsNode.transientStateStart, BBHelperReplacementsNode.transientStateEnd, generateExpectedRangeMappingNodeReplacement());
    }
            ...
            throws Exception
    {
        ...
        runReplacementTestScenario(context, nodeStart, transientStateStart, transientStateEnd, cluster, nodesToRemove, expectedRangeMappings);
    }

    /**
     * Generates expected token range and replica mappings specific to the test case involving a 5 node cluster with the last node replaced with a new node
     * <p>
     ...
     * <p>
     * eg. Range 1 - A, B, C Range 2 - B, C, D (with D being replaced with E) Expected Range 2 - B, C, D, E (With E taking over the range of the node being
     * replaced)
     */
    private Map<String, Map<Range<BigInteger>, List<String>>> generateExpectedRangeMappingNodeReplacement()
    {
        ...
        mapping.put(expectedRanges.get(2), Arrays.asList("127.0.0.3", "127.0.0.4", "127.0.0.5", "127.0.0.6"));
        mapping.put(expectedRanges.get(3), Arrays.asList("127.0.0.4", "127.0.0.5", "127.0.0.1", "127.0.0.6"));
        mapping.put(expectedRanges.get(4), Arrays.asList("127.0.0.5", "127.0.0.1", "127.0.0.2", "127.0.0.6"));
