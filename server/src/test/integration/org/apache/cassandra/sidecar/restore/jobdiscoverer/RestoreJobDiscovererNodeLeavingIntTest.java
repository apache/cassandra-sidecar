...
class RestoreJobDiscovererNodeLeavingIntTest extends IntegrationTestBase
{
    ...
    void testUpdateRestoreRangesWhenNodeLeaving(ConfigurableCassandraTestContext cassandraTestContext)
    {
        ...
        {
            BBHelperLeavingNode.transientStateEnd.countDown();
        }
    }
