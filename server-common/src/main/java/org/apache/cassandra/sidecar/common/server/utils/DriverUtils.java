...
/**
 * A shim layer that provides information from the Cassandra driver. Instead of accessing the {@link com.datastax.driver.core.DriverUtils} directly, this acts
 * as a proxy that can be swapped out based on the specific Sidecar implementation. This can be useful if a different driver version is used
 */
public class DriverUtils
{
     ...
     */
    public void startPeriodicReconnectionAttempt(Cluster cluster,
                                                 Host host)
    {
     ...
     */
    public Host getHost(Metadata metadata,
