...
{
    public KeyspaceNotFoundException(String keyspace)
    {
        super(makeErrorMessage(keyspace));
    }

    public KeyspaceNotFoundException(String keyspace, Throwable cause)
    {
        super(makeErrorMessage(keyspace), cause);
    }

    private static String makeErrorMessage(String keyspace)
    {
        return "Keyspace " + keyspace + " was not found";
    }
}
