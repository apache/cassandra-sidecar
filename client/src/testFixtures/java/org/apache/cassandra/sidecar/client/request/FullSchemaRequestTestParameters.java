...
/**
 * Unit tests for client requests accessing the full database schema
 */
public class FullSchemaRequestTestParameters implements RequestTestParameters<SchemaResponse>
{
    @Override
    ...
    {
        return ApiEndpointsV1.ALL_KEYSPACES_SCHEMA_ROUTE;
    }
